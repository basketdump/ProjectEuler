...
# NOTE: I did do an improved version of this
#       but I don't see how this could be recursive
#       with having to square it at the end.
#       Summing only can definitely be recursive, though.
